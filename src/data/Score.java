...
public class Score {
	...
	/**
	 * no-arg constructor This is the only constructor for the class. If you wish to
	 * use a different filename, edit it here.
	 */
	public Score() {
		try {
	 ...
	 * score, in the format of name + space + score, or ABC 500, with each score
	 * listed on a different line. This is ordered with high scores at the top, and
	 * lower scores at the bottom.
	 * 
	 ...
	 * updated based on the current user's score. If it does need to be updated,
	 * then it will update it. If the scores are in the wrong order, then this is
	 * the place to fix. If there are less than 3 high scores, then the user's score
	 * will automatically added. Additionally, if high scores are updated, then the
	 * method will automatically write them to file
	 * 
